...
reported to the maintainers by opening a confidential report via GitHub (see
the repository's Security tab) or, where that is not appropriate, by
contacting the maintainer directly through their GitHub profile. All
